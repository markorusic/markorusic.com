...
description: 'Enables us to sync state with URL's query parameters. Most common use case is when we need to shareable link to filtered data, so we sync our filtering state with query params.'
logo: 'react.png'
---
